    ...
    <div className="p-6 bg-white shadow rounded-lg">
      ...
      <div className="mb-4 space-x-4">
        ...
        <button
          ...
          className={`px-4 py-2 font-semibold ${
            filter === "Complete" ? "text-blue-600" : "text-gray-600"
          }`}
        >
          Completed
        </button>
        ...
        <div className="flex space-x-2">
          {[
            ...
            <button
              ...
              className={`px-3 py-1 ${
                currentPage === page + 1 ? "bg-blue-100" : "bg-gray-200"
              } rounded-md`}
            >
              {page + 1}
            </button>
